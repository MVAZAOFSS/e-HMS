...
<div id="page-wrapper" style="background-color:#fff">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('rooms/release') }}">Rooms release</a></li> 
            <li class="active"> view add days requests</li>                   
        </ol>
 <!--response messages-->
         @if(isset($emsg))
...
<table class='table table-striped table-responsive table-bordered' id='stafftale' >
              ...
              <tbody>
                  <?php $i = 1;  $nts = Notification::whereRaw("nfrom = 'room controller' and ntype = 'add days' and removed='no'")->get(); ?>
                    @foreach($nts as $m)
                    <tr>
                        <td>{{ $i++ }}</td>
                         <td> You </td>
