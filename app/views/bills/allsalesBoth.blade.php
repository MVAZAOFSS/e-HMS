...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="background-color:#fff">
        ...
        <ol class="breadcrumb">
            ...
            @if(Auth::user()->role == 8)
            <li><a href="{{ url("bill/sales/addBoth") }}">add bar sale </a></li>
            ...
            <table class='table table-striped table-responsive table-bordered' id='stafftale' >
                ...
                <tr>
                    ...
                    <td>{{$s->date}}
                        ...
                        @if(Auth::user()->role == 8)
                        <a href="{{url('sells/printbarzBoth/'.$s->id)}}" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-cloud"></span> print</a>
                        @endif
                        @endif
                    </td>
                </tr>
