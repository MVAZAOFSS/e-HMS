...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="background-color:#fff">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('bill/addBoth') }}">add bill information</a></li>
        </ol>
        <!--response messages-->
        @if(isset($emsg))
            ...
            <table class='table table-striped table-responsive table-bordered' id='stafftale' >
                ...
                <tr>
                    ...
                    <td id="{{$b->id}}">
                        ...
                        @if(Auth::user()->role ==8)
                        <a href="{{url('bills/printbarBoth/'.$b->id)}}" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-cloud-upload"></span> print</a>
                        @endif
                        @endif
                    </td>
                </tr>
        ...
        $("#stafftale").dataTable({
            ...
            "fnDrawCallback": function( oSettings ) {
                $(".bll").click(function(){
                    ...
                    $('#main').html("");
                    $('#ajax7').show();
                    $.post('loadbillBoth',{id:id1}, function(data){
                        $('#ajax7').hide();
                        $('#main').html(data);
                    });
