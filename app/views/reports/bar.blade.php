...
<ol class="breadcrumb">
            ...
            <li class="active">Bar reports </li>
...
$(document).ready(function(){
    ...
    e.preventDefault();    
     ...
     var resta=document.getElementById('bar').value;
     ...
     if(guest===''||resta===''||service===''||timely===''){
       ...
       if(timely==='daily'){
           var datex=$('#date').val();
           var url="<?php echo url('bardaily_display');?>";
           ...
           var url="<?php echo url('barweekly_display');?>";
           ...
           var year=$('#mYear').val();
           var url="<?php echo url('barmonthly_display');?>";
          ...
          var year=$('#year').val();
          var url="<?php echo url('baryearly_display');?>";
