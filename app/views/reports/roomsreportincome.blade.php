...
@if(isset($month)&&isset($mYear) || isset($year) ||isset($start))
...
<center>
  @if(isset($date))
	<h4>Report of income of {{$rms}} Guests on {{$date}} </h4>
	@endif
  @if(isset($start) && isset($end))
  <h4>Report of income of {{$rms}} Guests from {{$start}} to {{$end}}</h4>
  @endif
                  ...
                  @if($rms == "all")
                    ...
                    <tr>
                        <td>{{ $i++ }}</td>
                         ...
                         <td>{{ Room::find(Guest::find($m->guestid)->room_number)->cost }}</td>
