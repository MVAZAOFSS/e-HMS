...
<a class="navbar-brand visible-lg" href="{{url("/home")}}">
	<p style="color: #FFF">Food browser</p>
</a>
...
<div id="page-wrapper" style="background-color:#fff">
     	<ol class="breadcrumb">
            ...
            <li ><a href="{{ url("restaurant/add") }}">add food </a></li>                            
        </ol>
                  ...
                  <?php $i = 1; ?>
	                  ...
	                  <tr>
	                      <td>{{ $i++ }}</td>
	                       ...
	                       <td>{{ $m->cost }}</td>
	                       <td id="{{ $m->id }}">
	                            <a href="{{url("restaurant/edit/{$m->id}")}}" title="edit Food" class="editfood"><i class="glyphicon glyphicon-pencil text-info"></i> edit</a>&nbsp;&nbsp;
           ...
           "fnDrawCallback": function( oSettings ) {
               $(".deletefood").click(function(){
                ...
                $("#yes").click(function(){
                    ...
                    $.post("restaurant/delete/"+id1,function(data){
