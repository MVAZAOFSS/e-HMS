<table class="table table-bordered table-condensed table-hover" id="income">
    ...
    <tbody><tr><td>{{$roomscost}}</td><td>{{$salescost}}</td><td></td>{{$baramount}}<td>{{$barcost}}</td><td>{{$amount}}</td><td>{{$co_amount}}</td><td>{{$fu_amount}}</td><td>{{$totalprice}}</td><td>{{$totalpricesales}}</td></tr></tbody>
</table>
