<div class="">
    ...
    <ul class="nav navbar-nav side-nav" id="side">
        ...
        <li><a href="{{url("guest/messages")}}"><span class="glyphicon glyphicon-question-sign"></span> Checkin <span class="badge pull-right" id="msg">{{Guest::whereRaw('reserved != ? and confirm = ? and arrival_date <= ?' , array('no',  'no', date("Y-m-d", strtotime("+1 day"))))->count()}}</span>  <img id="l" class="pull-right" style="display:none" src="{{url("img/load.gif")}}" /></a></li>
    ...
    <ul class="nav navbar-nav side-nav" id="side">
        <li><a href="{{url("home")}}"><span class="glyphicon glyphicon-home"></span> Home</a></li>
        <li><a href="{{url("accountant/income")}}"><span class="glyphicon glyphicon-arrow-down"></span> Income</a></li>
