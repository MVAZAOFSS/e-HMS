                      ...
                      $('#fdk').html('Room: <span style="color: blue">' + obj.room + '</span><br/> status: <span style="color: red"> occupied </span> <br/> Available date: <span style="color: green">' + obj.checkout + ' </span>').css({
                       ...
                       if(bk == "sio"){
                        ...
                        if(bk == "sio"){
                            ...
                            $('#fdk').html('Room: <span style="color: blue">' + obj.room + '</span><br/> status: <span style="color: green"> reserved! </span> <br/><br/><input type="hidden" name="r_no" id="r_no" value="{{str_pad(rand(0, 9999), 4, '0', STR_PAD_LEFT)}}"/><hr/><hr/><button class="btn btn-xs btn-success" data-toggle="modal" data-target="#myModal">Register Guest</button>').css({
                             'color': 'black',
                             'padding': '6px',
                             'border': '1px solid #ccc',
                             'border-radius': '7px',
